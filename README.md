...
2. Install your preferred flavor and accent combination theme from [`themes`](./themes/). (Make sure the folder and files have the same name, or kvantum won't recognize your theme, e.g. foo/foo.svg and foo/foo.kvconfig)
